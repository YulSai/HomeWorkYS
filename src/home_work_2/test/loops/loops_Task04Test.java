...
import static home_work_2.loops.loops_Task04.expNonOverflow;
import static home_work_2.loops.loops_Task04.expOverflow;
...
public class loops_Task04Test {
    ...
    public void checkExpNonOverflowFor3(){
        ...
        long answer = expNonOverflow(1,3);
    ...
    public void checkExpNonOverflowFor188(){
        ...
        long answer = expNonOverflow(1,188);
    ...
    public void checkExpNonOverflowForMinus19(){
        ...
        long answer = expNonOverflow(1,-19);
    ...
    public void checkExpNonOverflowForMinus200(){
        ...
        long answer = expNonOverflow(1,-200);
    ...
    public void checkExpOverflow3(){
        ...
        long answer = expOverflow(expNonOverflow(1,3), 3);
    ...
    public void checkExpOverflowMinus19(){
        ...
        long answer = expOverflow(expNonOverflow(1,-19), -19);
    ...
    public void checkExpOverflowMinus200(){
        ...
        long answer = expOverflow(expNonOverflow(1,-200), -200);
