 ...
 * использованием паттерна "Декоратор" и Generic
 */
public class CalculatorWithCounterAutoDecoratorGeneric<CALC extends ICalculator> implements ICalculator {
    private long count;
    private final CALC calc;

    public CalculatorWithCounterAutoDecoratorGeneric(CALC calc) {
        this.calc = calc;
    }
