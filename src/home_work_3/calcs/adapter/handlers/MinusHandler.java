...
/**
 * Класс обработки математических выражений из String для нахождения разности чисел
 */
public class MinusHandler extends PatternHandler implements IHandler {
    ...
    protected double calc(Matcher matcher) {
        ...
        return calculator.minus(Double.parseDouble(operand1), Double.parseDouble(operand2));
    }
