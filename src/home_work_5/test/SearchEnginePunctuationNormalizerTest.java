...
public class SearchEnginePunctuationNormalizerTest {
    ISearchEngine searchEngine = new SearchEnginePunctuationNormalizer(new SearchEngineIgnoreCase(new RegExSearch()));
    ...
    public void searchOneWord() {
        ...
        Assertions.assertEquals(3, searchEngine.search(text1, "война"));
        Assertions.assertEquals(3, searchEngine.search(text1, "Война"));
    }
    ...
    public void searchWordFromPatter() {
        ...
        Assertions.assertEquals(2, searchEngine.search(text1, "Краб"));
        Assertions.assertEquals(2, searchEngine.search(text1, "краб"));
    ...
    public void searchWordFromInhabitedIsland() {
        ...
        Assertions.assertEquals(6, searchEngine.search(text1, "было"));
