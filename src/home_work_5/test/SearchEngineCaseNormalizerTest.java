...
public class SearchEngineCaseNormalizerTest {
    ...
    public void searchOneWord() {
        ...
        Assertions.assertEquals(7, searchEngine.search(text1, "война"));
        Assertions.assertEquals(7, searchEngine.search(text1, "Война"));
    }
    ...
    public void searchWordForExampleFromTask() {
        ...
        Assertions.assertEquals(2, searchEngine.search(text6, "Привет"));
        Assertions.assertEquals(2, searchEngine.search(text6, "привет"));
        ...
        Assertions.assertEquals(3, searchEngine.search(text9, "бабушка"));
        Assertions.assertEquals(3, searchEngine.search(text9, "бабушке"));
        Assertions.assertEquals(3, searchEngine.search(text9, "бабушку"));
    ...
    public void searchWordFromPatter() {
        ...
        Assertions.assertEquals(4, searchEngine.search(text1, "Краб"));
        Assertions.assertEquals(4, searchEngine.search(text1, "краб"));
    ...
    public void searchWordFromSingle() {
        ...
        Assertions.assertEquals(4, searchEngine.search(text1, "калина"));
        Assertions.assertEquals(11, searchEngine.search(text1, "Гей"));
        Assertions.assertEquals(11, searchEngine.search(text1, "гей"));
        Assertions.assertEquals(7, searchEngine.search(text1, "Україну"));
    ...
    public void searchWordFromInhabitedIsland() {
        ...
        Assertions.assertEquals(2, searchEngine.search(text1, "небо"));
        Assertions.assertEquals(2, searchEngine.search(text1, "там"));
        Assertions.assertEquals(7, searchEngine.search(text1, "было"));
        Assertions.assertEquals(8, searchEngine.search(text1, "был"));
